...
from project_utils import generate_csv,load_data
...
if not os.path.isfile("Data/TrainData.pkl"):
    dataset.iloc[:int(dataset.shape[0]*0.80)].to_pickle("Data/TrainData.pkl")
...
if not os.path.isfile("Data/TestData.pkl"):
    dataset.iloc[int(dataset.shape[0]*0.80):].to_pickle("Data/TestData.pkl")
...
train_data["DayOfWeek"] = train_data.Date.weekday_name
